...
public class ClaimsControllerTests
{
    ...
    {
        var claims = new List<ClaimResponse> { new() { Id = "1", Name = "Test", CoverId = "c1" } };
    ...
    {
        var claim = new ClaimResponse { Id = "1", Name = "Test", CoverId = "c1" };
    ...
    public async Task Create_ReturnsOkWithCreatedClaim()
    {
        ...
        var created = new ClaimResponse { Id = "new-id", Name = "Test", DamageCost = 500, CoverId = "c1" };
